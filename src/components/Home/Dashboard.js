...
function Dashboard() {
  ...
  const { loading, transactions, products } = useSelector(bankingSelector);
                ...
                <TableRow key={i}>
                  <TableCell>
                    <div className="flex items-center text-sm">
                      <div>
                        <p className="font-semibold">{user.transactionID}</p>
                  ...
                  <TableCell>
                    <span className="text-sm">{new Date(user.date).toString()}</span>
                  </TableCell>
                  <TableCell>
                    <span className="text-sm">
                      <Badge type={user.status}>Test</Badge>
                    </span>
                  </TableCell>
                </TableRow>
              ))}
